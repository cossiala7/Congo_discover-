...
### RÈGLES STRICTES ###
1. Si la réponse n'est pas dans le contexte, dis "Je ne sais pas, désolé".
2. Sois précis, structuré et utilise un ton professionnel.
3. Ne mentionne pas que tu utilises un document.
"""

    messages = [
        SystemMessage(content="Tu es un système RAG expert. La vérité est uniquement dans le contexte."),
